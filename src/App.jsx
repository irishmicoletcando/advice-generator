...
export default function App() {
  ...
  return (
    <div className="bg-darkBlue min-h-screen font-manrope text-white flex items-center justify-center p-4 overflow-y-hidden">
      <div className="relative w-full max-w-[340px] sm:max-w-[540px] bg-darkGrayishBlue px-6 sm:px-10 pt-10 pb-16 space-y-6 text-center rounded-2xl shadow-lg">
        <h1 className="text-xs sm:text-sm tracking-[0.3em] text-neonGreen font-bold">
          ADVICE #{advices.id}
        </h1>
        <p className="font-extrabold text-lightCyan text-[20px] sm:text-[28px] leading-tight">
          {advices.advice}
        </p>
        <div className="pt-4">
        ...
        <button
          ...
          className="absolute left-1/2 transform -translate-x-1/2 bottom-[-32px] bg-neonGreen w-16 h-16 rounded-full flex items-center justify-center hover:shadow-[0_0_30px_rgba(82,255,168,0.7)] transition-shadow"
        >
